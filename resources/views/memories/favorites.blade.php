                ...
                <div class="p-4">
                    <div class="flex flex-wrap gap-4 items-center">
                        <div class="flex-1 min-w-[200px]">
                            <input type="text" placeholder="Pesquisar memórias favoritas..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-teal focus:ring focus:ring-teal focus:ring-opacity-50">
                        </div>
                    ...
                    <div class="col-span-full">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-amber/20">
                            <div class="p-6 text-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Nenhuma memória favorita encontrada</h3>
                                <p class="text-gray-600 mb-4">Comece marcando suas memórias favoritas!</p>
                                <a href="{{ route('memories.index') }}" class="inline-flex items-center gap-2 bg-amber hover:bg-amber-dark text-white px-4 py-2 rounded-md transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
