<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('memories.show', $memory) }}" class="text-sm text-teal hover:underline flex items-center">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-amber/20">
                <div class="p-6">
                    <form method="POST" action="{{ route('memories.update', $memory) }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="border-b border-amber/10 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title', $memory->title) }}" required
                                ...
                                <div>
                                    ...
                                    <select name="category_id" id="category_id" required
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('category_id', $memory->category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_favorite" id="is_favorite" value="1" {{ old('is_favorite', $memory->is_favorite) ? 'checked' : '' }}
                        ...
                        <div class="border-b border-amber/10 pb-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="6" required
                                    class="w-full rounded-md border-amber/20 focus:border-teal focus:ring focus:ring-teal/20 transition-colors"
                                    placeholder="Descreva os detalhes desta memória...">{{ old('description', $memory->description) }}</textarea>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    @if($memory->image_media_path)
                                        <div class="mb-2">
                                            ...
                                            <div class="mt-1 relative aspect-video w-64 bg-gray-100 rounded-lg overflow-hidden">
                                                <img src="{{ Storage::url($memory->image_media_path) }}" 
                                                     alt="Imagem atual da memória" 
                                    ...
                                    <div id="image-preview" class="mt-2 hidden">
                                        <p class="text-sm font-medium text-teal">Nova imagem selecionada:</p>
                                ...
                                <div>
                                    ...
                                    @if($memory->audio_media_path)
                                        <div class="mb-2">
                                            <p class="text-sm text-gray-500">Áudio atual:</p>
                                    ...
                                    <div id="audio-preview" class="mt-2 hidden">
                                        <p class="text-sm font-medium text-teal">Novo áudio selecionado:</p>
                                ...
                                <div>
                                    ...
                                    @if($memory->video_media_path)
                                        <div class="mb-2">
                                            <p class="text-sm text-gray-500">Vídeo atual:</p>
                                            <div class="mt-1 relative aspect-video w-64 bg-gray-100 rounded-lg overflow-hidden">
                                    ...
                                    <div id="video-preview" class="mt-2 hidden">
                                        <p class="text-sm font-medium text-teal">Novo vídeo selecionado:</p>
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            <a href="{{ route('memories.show', $memory) }}" class="px-4 py-2 rounded-md border border-amber text-amber hover:bg-amber hover:text-white transition-colors">
                                Cancelar
                            </a>
